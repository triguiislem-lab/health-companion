...
import { Sparkles, RefreshCw, Save, CheckCircle2, X, Pencil, ShieldCheck, Brain } from "lucide-react";
import { patients, prescriptions, safetyAlerts, type Medication } from "@/lib/mock-data";
...
function NewPrescription() {
  const patient = patients[0]; // Eleanor — the high-risk demo case
  ...
  const [meds, setMeds] = useState<Medication[]>(initialRx.medications);
  ...
  return (
    <div className="p-4 lg:p-6 space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="text-xs text-muted-foreground">Case <span className="font-mono font-semibold text-foreground">RX-2087</span> · Model v3.2.1</div>
      </div>
            ...
            <div className="rounded-xl border border-border bg-card shadow-card overflow-hidden">
              ...
              <div className="divide-y divide-border">
                ...
                {meds.length === 0 && (
                  <div className="px-5 py-10 text-center text-sm text-muted-foreground">
                    No medications. Generate or add manually.
                  </div>
                )}
              </div>
              ...
              <div className="px-5 py-4 border-t border-border bg-muted/30 flex flex-wrap gap-2">
                ...
                <div className="ml-auto">
                  ...
                  >
                    <ShieldCheck className="h-3.5 w-3.5" /> Validate prescription
                  </button>
                </div>
              </div>
